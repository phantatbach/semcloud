...
The functions in this vignette take output from the `semasioflow` Python package and from the [cloud processing vignette](processClouds.html), prepares the data to be used in the [Level3 ShinyApp](https://github.com/montesmariana/Level3) and shows how to classify clouds according to said typology.
...
The current workaround is to leave the HDBSCAN visualization to the [Level3 ShinyApp](https://github.com/montesmariana/Level3),
